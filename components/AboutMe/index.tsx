  ...
  return (
    <div className='bg-secondary-gray px-2.5 py-8'>
      ...
      <div className='font-sans text-md leading-5'>
        ...
        <br />
        <br />
        I have practiced for the past eleven years with an emphasis on trauma
        stemming from neglect and abuse. I also have experience working with
        children with autism and their families in educational and residential
        settings.
        <br />
        <br />
